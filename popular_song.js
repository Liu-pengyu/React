...
export default class SongList extends Component {
    ...
    _renderItem=({item})=>{
        return (
            <View style={{height:80,flexDirection:'row',width:"100%",marginTop:5}}>
                ...
                <View style={{width:"80%"}}>
                    <Text style={{fontSize:20,color:'white',height:50,opacity:0.5}} onPress={()=>this._goMusic(item.songName)}>  {item.songName}</Text>
                    <View style={{flexDirection:'row'}}>
                        <Text style={{fontSize:15,color:'white',opacity:0.5}}>   作者：{item.songUser}</Text>
                        <Text style={{fontSize:15,color:'white',opacity:0.5}}>   类别：{item.songType}</Text>
                    </View>
    ...
    render() {
        return (
            <View >
                <ImageBackground style={{width:"100%",height:"100%"}} source={{uri:"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1592767789858&di=67e77528df644378176999d1886c131f&imgtype=0&src=http%3A%2F%2Fpic2.zhimg.com%2F50%2F649ab9110cd3f6c3f7912cb5b9d64144_hd.jpg"}}>
                    <FlatList
